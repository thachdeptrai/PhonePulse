    ...
    public class SocketManager {
        ...
        */
        public static void joinRoom(String roomId, String userId, String userType) {
            if (!isConnected()) {
                Log.e(TAG, "Socket not connected, cannot join room.");
                return;
            }
            try {
                ...
                Log.d(TAG, "Emitted 'join_room' event via socket: " + data.toString());
            } catch (JSONException e) {
                Log.e(TAG, "JSONException creating payload for joinRoom: " + e.getMessage());
            } catch (Exception e) {
                Log.e(TAG, "Exception emitting joinRoom: " + e.getMessage(), e);
            }
        }
